  ...
  return (
	<div>
		...
		<div id="background-wrap">
			...
			<div>
				<img alt="prout" useMap="#spongebobbg" className="clickable" src="http://217.160.41.142:80/pictures/bobhouse.png" width="auto" style={{position: "absolute", top: 0, bottom: 0, right: 0, left: 0, margin: "auto"}}/>
			</div>
