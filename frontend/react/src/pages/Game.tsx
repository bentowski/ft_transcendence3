...
const start = (ctx: any) => {
    ...
    socket.on('newPoint', (room) => {
      ...
      {
        case 0: score1.src = "http://217.160.41.142:80/icons/0.png"
          break;
        case 1: score1.src = "http://217.160.41.142:80/icons/1.png"
          break;
        case 2: score1.src = "http://217.160.41.142:80/icons/2.png"
          break;
        case 3: score1.src = "http://217.160.41.142:80/icons/3.png"
          break;
        case 4: score1.src = "http://217.160.41.142:80/icons/4.png"
          break;
        case 5: score1.src = "http://217.160.41.142:80/icons/5.png"
          break;
        case 6: score1.src = "http://217.160.41.142:80/icons/6.png"
          break;
        case 7: score1.src = "http://217.160.41.142:80/icons/7.png"
          break;
        case 8: score1.src = "http://217.160.41.142:80/icons/8.png"
          break;
        case 9: score1.src = "http://217.160.41.142:80/icons/9.png"
          break;
        case 10: score1.src = "http://217.160.41.142:80/icons/10.png"
          break;
      }
      switch (room.config.p2Score)
      {
        case 0: score2.src = "http://217.160.41.142:80/icons/0.png"
          break;
        case 1: score2.src = "http://217.160.41.142:80/icons/1.png"
          break;
        case 2: score2.src = "http://217.160.41.142:80/icons/2.png"
          break;
        case 3: score2.src = "http://217.160.41.142:80/icons/3.png"
          break;
        case 4: score2.src = "http://217.160.41.142:80/icons/4.png"
          break;
        case 5: score2.src = "http://217.160.41.142:80/icons/5.png"
          break;
        case 6: score2.src = "http://217.160.41.142:80/icons/6.png"
          break;
        case 7: score2.src = "http://217.160.41.142:80/icons/7.png"
          break;
        case 8: score2.src = "http://217.160.41.142:80/icons/8.png"
          break;
        case 9: score2.src = "http://217.160.41.142:80/icons/9.png"
          break;
        case 10: score2.src = "http://217.160.41.142:80/icons/10.png"
          break;
      }
    })
...
const initSettings = (serv: any) => {
  score1.src = "http://217.160.41.142:80/icons/0.png"
  score2.src = "http://217.160.41.142:80/icons/0.png"
  settings = {
    w: settings.w,
    h: settings.h,
