...
const Menu = () => {
  ...
  const logoutSession = async () => {
    ...
    const linkChat = () => {
      if (window.location.href.includes("217.160.41.142:80/chat"))
        return (
    ...
    return (
      <div className="Menu shadow d-flex justify-content-between align-items-center">
        ...
        <div className="titleDiv d-none d-sm-block">
          <h1 className="m-0"><img alt="" className="BobLePong" src="http://217.160.41.142:80/pictures/boblepongelogo.png"/></h1>
        </div>{" "}
        {/* titleDiv */}
