        ...
        return (
          <div className='historyDiv m-0 my-2 d-flex flex-row justify-content-between align-items-center'>
            ...
            <div className='col-4 d-flex flex-row justify-content-end align-items-center'>
              ...
              <img src={"http://bentowski.fr:3000/user/" + this.props.history.user_two_id + "/avatar"} alt="" className='miniAvatar' />
            </div>
          </div>
        )
      else {
      ...
      return (
        <div className='historyDiv m-0 my-2 d-flex flex-row justify-content-between align-items-center'>
          <div className='col-2 d-flex flex-row'>
            <img src={"http://bentowski.fr:3000/user/" + this.props.history.user_one_id + "/avatar"} alt="" className='miniAvatar' />
