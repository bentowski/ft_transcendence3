...
import '../../styles/utils/historyCards.css'
import Request from "./Requests"

class HistoryCards extends Component<{ history: any }, {}> {
    ...
    return (
      <div className='historyDiv m-0 p-0 my-2 d-flex flex-row justify-content-between'>
        ...
        <div className='col-4 d-flex flex-row justify-content-center'>
          ...
          <div className='col-5 d-flex flex-row justify-content-start'>{this.props.history.score_two}</div></div>
